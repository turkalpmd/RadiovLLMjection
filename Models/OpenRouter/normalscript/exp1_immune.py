...
# I/O
IMAGES_DIR = "/home/ubuntu/RadiovLLMjection/Images/ProjectImg/injected_normals"
OUT_DIR    = "/home/ubuntu/RadiovLLMjection/Results/OpenRouter/normal"
CUSTOM_FIELD = "injection_immune_real"  # filename tag: model_custom_timestamp.json
...
def main():
    ...
    print("🚀 OPENROUTER VLM INJECTION TEST (immune system prompt, multi-model)")
    print("=" * 60)
    ...
    for model in MODEL_LIST:
        ...
        for p in files:
            ...
            meta = generate_with_retry(client, model, data_url, SYSTEM_PROMPT, NAIVE_PROMPT, MAX_TOKENS)
        ...
        if json_files and not SMOKE_TEST:
            try:
                with open(json_files[0], "r", encoding="utf-8") as f:
                    ...
                    if recent_data.get("model") == model and recent_data.get("prompt_type") == "immune":
