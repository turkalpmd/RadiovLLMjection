...
# -*- coding: utf-8 -*-
"""
OpenAI VLM OCR Tester (multi-model iterative, in-script config, JSON-only)
...
- Exponential backoff
- Saves JSON to:
  /home/ubuntu/RadiovLLMjection/Results/OpenAI/<model>_OCR_<timestamp>.json
"""
